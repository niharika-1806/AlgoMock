...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "`$env:JAVA_HOME='$env:JAVA_HOME'; `$env:JWT_SECRET='$env:JWT_SECRET'; cd '$root\backend'; .\mvnw.cmd spring-boot:run"
